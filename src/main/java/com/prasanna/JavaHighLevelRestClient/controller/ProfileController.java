package com.prasanna.JavaHighLevelRestClient.controller;
...
import com.prasanna.JavaHighLevelRestClient.service.ProfileService;
...
public class ProfileController {
	...
	@DeleteMapping("/{id}")
	public String deleteProfile(@PathParam("id") String id) throws Exception {
